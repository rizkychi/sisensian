                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" name="leave_date" data-provider="flatpickr" data-date-format="Y-m-d" data-altFormat="d-m-Y" data-range-date="true" data-minDate="today" data-allow-input="true" data-default-date="{{ old('leave_date') }}" required>
